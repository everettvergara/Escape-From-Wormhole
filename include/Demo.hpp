...
namespace g80 {
    ...
    auto Demo::update_states() -> bool {
        ...
        line({50, 700}, {300, 50}, SDL_MapRGBA(surface_->format, 255, 0, 0, 255));
        line({300, 50}, {900, 300}, SDL_MapRGBA(surface_->format, 255, 0, 0, 255));
        line({900, 300}, {700, 50}, SDL_MapRGBA(surface_->format, 255, 0, 0, 255));

        catmullrom_spline_lite({{50, 700}, {300, 50}, {900, 300}, {700, 50}}, 50, pal, 0, 39);
        /// catmullrom_spline_lite({{50, 700}, {300, 50}, {900, 300}, {700, 50}}, 50, SDL_MapRGBA(surface_->format, 255, 255, 255, 255));
        // exit(0);
